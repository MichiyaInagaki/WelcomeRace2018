...
public class GarupanResult : MonoBehaviour {
	...
	private static int high_punchscore = 0;
	...
	void Start () {
		...
		_punchscore = GarupanCnotroller.getPunchScore();
		scoretext.text = "Score: "+ _punchscore;

		//highscore
		if (_punchscore >= high_punchscore) {
			high_punchscore = _punchscore;
		}
		HighScore.text = "High Score: "+ high_punchscore;
	}
